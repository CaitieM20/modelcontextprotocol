...
| `"private"` | The response contains user-specific data. Only the requesting user's client **MAY** cache it. Shared caches **MUST NOT** serve it to a different user.  |


#### Choosing a Cache Scope

- **`"public"`** is appropriate for lists of tools, prompts, and resource templates that
