...
|-----|-------|--------|------|---------|
| [SEP-2549](/seps/2549-TTL-for-list-results) | TTL for List Results | <Badge color="gray" shape="pill">Accepted with Changes</Badge> | Standards Track | 2026-04-09 |
